    ...
    <header className='bg-slate-200 shadow-md'>
      ...
      <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
        ...
        <ul className='flex gap-4 '>
          ...
          <Link to='/profile'>
          {currentUser ? (<img className='rounded-full h-8 w-8 object-cover' src={currentUser.avatar} alt='profile' />):<li className='sm:inline text-slate-700 hover:underline'>Sign in</li>}
